...
**Status:** Phase 0 complete. Playable, scored, 973 tests, **zero third-party
...
| `boss <id>` | Run a multi-step boss fight (`--live` to watch it execute line by line; when a step breaks, fix the line and resume, spending one of your repairs — `--repairs` sets the pool, `--fix <file>` scripts the edit) |
...
tests/                973 tests, stdlib unittest
